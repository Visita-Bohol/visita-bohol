...
export default function BottomSheet({ isOpen, church, isVisited, onClose, SpecialHeader }) {
    ...
    return (
        <>
            ...
            <div
                ref={sheetRef}
                className={`fixed bottom-0 left-0 right-0 bg-white z-[2000] border-t-left-radius-[24px] border-t-right-radius-[24px] shadow-[0_-10px_40px_rgba(0,0,0,0.1)] transition-transform duration-400 ease-[cubic-bezier(0.16,1,0.3,1)] max-h-[75vh] flex flex-col ${isOpen ? 'translate-y-0' : 'translate-y-full'}`}
