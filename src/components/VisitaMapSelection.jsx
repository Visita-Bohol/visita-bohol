...
const createChurchIcon = (church, isSelected) => {
    ...
    // If selected for this step, maybe highlight it? 
    // For now, standard coloring but maybe a bigger size or border if selected.

    return L.divIcon({
        className: 'custom-div-icon',
        html: `
            <div class="flex items-center justify-center w-8 h-8 rounded-full" 
                 style="background-color: ${markerColor}; border: 2px solid white; color: white; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.3); transform: ${isSelected ? 'scale(1.2)' : 'scale(1)'}">
...
export default function VisitaMapSelection({ churches, onSelect, onClose, currentStep }) {
